...
pub fn get_available_moods() -> Vec<&'static str> {
    vec!["didatico", "cetico", "entusiasta", "direto", "provocador", "analitico"]
}

pub fn get_axes_for_mood(mood: &str) -> PersonalityAxes {
    match mood.to_lowercase().as_str() {
        "didatico" => PersonalityAxes {
            concise_vs_expansive: "Expansivo, explica conceitos detalhadamente com analogias.".into(),
            didactic_vs_direct: "Muito didático, preocupado em garantir o entendimento do público.".into(),
        ...
        "cetico" => PersonalityAxes {
            ...
            skeptical_vs_enthusiastic: "Bastante cético, questiona promessas exageradas e Hype.".into(),
            formal_vs_casual: "Moderadamente formal e analítico.".into(),
            analytical_vs_storytelling: "Foco analítico em métricas, custos e viabilidade real.".into(),
            provocative_vs_conciliatory: "Provocador, desafia o interlocutor com perguntas difíceis.".into(),
        },
        "entusiasta" => PersonalityAxes {
            ...
            analytical_vs_storytelling: "Usa storytelling estimulante e metáforas inspiradoras.".into(),
        ...
        "direto" => PersonalityAxes {
            ...
            didactic_vs_direct: "Extremamente direto, sem enrolação ou contextualização excessiva.".into(),
